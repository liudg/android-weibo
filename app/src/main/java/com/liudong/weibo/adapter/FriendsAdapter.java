...
public class FriendsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FriendsAdapter(Context context, List<User> datas) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHolder holder = new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_friends, parent, false));
        return holder;
    }
